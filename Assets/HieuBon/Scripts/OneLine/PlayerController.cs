...
namespace OneLine
{
    public class PlayerController : MonoBehaviour
    {
        ...
        public IEnumerator Win()
        {
            ...
            scaleLine = DOVirtual.Float(0.25f, 0.3f, 0.25f, (v) =>
            {
            ...
            for (int i = 0; i < scBoxPassed.Count; i++)
            {
                ...
                scBoxPassed[i].PlayLightWinAni();
            }
            delayFade = DOVirtual.DelayedCall((scBoxPassed.Count - 1) * time, delegate
            {
                ...
                scaleLine = DOVirtual.Float(0.3f, 0.25f, 0.25f, (v) =>
                 {
                     lineRenderer.startWidth = v;
                     lineRenderer.endWidth = v;
                 }).SetUpdate(true);
